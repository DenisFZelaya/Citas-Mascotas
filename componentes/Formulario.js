...
const Formulario = ({citas, setCitas, guadarMostrarForm}) => {
  // Creando el state
  ...
  //Realizar accion al confirmar
  const handleConfirm = (date) => {
    //convertir la fecha a espa;ol
  ...
  const confirmarHora = (hora) => {
    //console.warn('A hour has been picked: ', hora);
    //convertir a hora en espa;ol
